    ...
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li className={`nav-item `}>
            <a className={`nav-link ${styles.a}`} href="#">Skills</a>
          </li>
          <li className={`nav-item `}>
            <a className={`nav-link ${styles.a}`} href="#">Gallery</a>
          </li>
          <li className={`nav-item `}>
            <a className={`nav-link ${styles.a}`} href="#">Extras</a>
          </li>
          <li className={`nav-item `}>
            <a className={`nav-link ${styles.a}`} href="#">Contact</a>
          </li>
